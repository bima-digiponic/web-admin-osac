<?php namespace App\Http\Controllers;
	...
	class AdminServicesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Tipe","name"=>"kategori",'join'=>'tb_general,keterangan'];
			$this->col[] = ["label"=>"Kendaraan","name"=>"jenis_kendaraan",'join'=>'tb_general,keterangan'];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Tipe','name'=>'kategori','type'=>'radio','validation'=>'required','width'=>'col-sm-10','datatable'=>'tb_general,keterangan','datatable_where'=>'kode_tipe = 9'];
			$this->form[] = ['label'=>'Kendaraan','name'=>'jenis_kendaraan','type'=>'radio','validation'=>'required','width'=>'col-sm-10', 'datatable'=>'tb_general,keterangan','datatable_where'=>'kode_tipe = 10'];
			$this->form[] = ['label'=>'Nama','name'=>'name','type'=>'text','validation'=>'required|string|max:70','width'=>'col-sm-10','placeholder'=>'Ketikkan nama jasa'];
			$this->form[] = ['label'=>'Harga','name'=>'price','type'=>'money','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Gambar','name'=>'gambar','type'=>'upload','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Kendaraan","name"=>"kendaraan","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			...
			//$this->form[] = ["label"=>"Tipe","name"=>"tipe","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
